...
<head>
    ...
    <title>Knight's DragonFire</title>
...
<footer>
    <ul class="nav justify-content-center border-bottom pb-3 mb-3">
        <li>
            <a href="#" class="nav-link px-2 text-muted">Knight's DragonFire</a>
        </li>
    </ul>
    <p class="text-center text-muted">Copyright LucasGames 2024-Todos los Derechos Reservados</p>
</footer>
